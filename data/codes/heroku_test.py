# Test Salesforce oauth loginimport os.pathimport pickle
...
print "............."packet = salesforce_oauth_request.login(username=username, password=password, client_id=client_id, client_secret=client_secret, redirect_uri=redirect_uri										)
print "Access token: %s" % packet['access_token']print "Refresh token: %s" % packet['refresh_token']print "Instance URL: %s" % packet['instance_url']