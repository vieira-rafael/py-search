#!/usr/bin/env python## Very basic PyADB example#
try: import sys from pyadb import ADBexcept ImportError,e: # should never be reached print "[f] Required module missing. %s" % e.args[0]    sys.exit(-1)
