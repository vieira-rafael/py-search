...
##   Elliptic Curve Digital Signature Algorithm (ECDSA)##   COPYRIGHT (c) 2010 by Toni Mattis <solaris@live.de>#
import hashlib
from os import urandom
from elliptic import inv, mulf, mulp, muladdp, elementfrom curves import get_curve, implemented_keys
...
if __name__ == '__main__':
 ...
 def test_perf(bits, rounds=50): '''-> (key generations, signatures, verifications) / second'''        h = 0x0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF        d = get_curve(bits)
        ...
        t = time.time() for i in xrange(rounds):            verify(0, s, qk)        tver = time.time() - t
